...
if (exists("metrics_yours") && exists("metrics_full")) {
  kable(dplyr::bind_rows(metrics_yours, metrics_full),
        caption = "Training vs Full-Data Performance",
        digits = 3)
} else {
  cat("Metrics tables `metrics_yours` and/or `metrics_full` not available.\n",
      "Run the analysis that creates these objects (e.g. scripts/analysis-main.R) or",
      "define them in an earlier chunk to display the comparison table.")
}
```
